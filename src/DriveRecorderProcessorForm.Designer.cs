namespace DriveRecorderConverter
{
    partial class DriveRecorderProcessorForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            iDriveFlowPanel = new FlowLayoutPanel();
            iDriveLabel = new Label();
            iDriveCombo = new ComboBox();
            ...
            DriverNameCheck = new ColoredCheckBox();
            CarNameCheck = new ColoredCheckBox();
            SpeedCheck = new ColoredCheckBox();

            CamNameCheck = new ColoredCheckBox();
            DateTimeCheck = new ColoredCheckBox();
            LocationCheck = new ColoredCheckBox();
            VinCheck = new ColoredCheckBox();
            InterpolateGroup = new GroupBox();
            InterpolateTablePanel = new TableLayoutPanel();
            InterpolateFlowPanel = new FlowLayoutPanel();
            InterpolateDescLabel = new Label();
            InterpolateCheck = new ColoredCheckBox();
            ...
            TrimCheck = new ColoredCheckBox();
            SplitCheck = new ColoredCheckBox();
            FlipCheck = new ColoredCheckBox();
            ScaleCheck = new ColoredCheckBox();
            ...
            MphModeCheck = new ColoredCheckBox();
            OverwriteCheck = new ColoredCheckBox();
            AppendDateCheck = new ColoredCheckBox();
            ...
            InterpolateTablePanel.SuspendLayout();
            ...
            MainFlowPanel.Controls.Add(PathValidationLabel);
            MainFlowPanel.Controls.Add(iDriveFlowPanel);
            ...
            PathFlowPanel.Margin = new Padding(3, 10, 3, 0);
            ...
            // PathValidationLabel
            // 
            PathValidationLabel.AutoSize = true;
            PathValidationLabel.ForeColor = Color.Red;
            PathValidationLabel.Margin = new Padding(6, 0, 3, 0);
            PathValidationLabel.Name = "PathValidationLabel";
            PathValidationLabel.Size = new Size(300, 20);
            PathValidationLabel.Text = "";
            PathValidationLabel.Visible = false;
            // 
            // iDriveFlowPanel
            // 
            iDriveFlowPanel.AutoSize = true;
            iDriveFlowPanel.Controls.Add(iDriveLabel);
            iDriveFlowPanel.Controls.Add(iDriveCombo);
            iDriveFlowPanel.Dock = DockStyle.Top;
            iDriveFlowPanel.Margin = new Padding(3, 10, 3, 0);
            iDriveFlowPanel.Name = "iDriveFlowPanel";
            iDriveFlowPanel.TabIndex = 28;
            // 
            // iDriveLabel
            // 
            iDriveLabel.Anchor = AnchorStyles.Top | AnchorStyles.Bottom | AnchorStyles.Left;
            iDriveLabel.AutoSize = true;
            iDriveLabel.Name = "iDriveLabel";
            iDriveLabel.TabIndex = 0;
            iDriveLabel.Text = "iDrive Version :";
            iDriveLabel.TextAlign = ContentAlignment.MiddleLeft;
            // 
            // iDriveCombo
            // 
            iDriveCombo.FormattingEnabled = true;
            iDriveCombo.Items.AddRange(new object[] { "7", "8" });
            iDriveCombo.Name = "iDriveCombo";
            iDriveCombo.Size = new Size(60, 28);
            iDriveCombo.TabIndex = 1;
            iDriveCombo.SelectedIndex = 1;
            iDriveCombo.SelectedIndexChanged += IDriveCombo_SelectedIndexChanged;
            // 
            // FolderLabel
            // 
            ...
            FolderLabel.Text = "Drive Recorder File Location :";
            ...
            CamSelectGroup.Margin = new Padding(3, 10, 3, 0);
            ...
            AllCamsRadio.CheckedChanged += CameraSelection_CheckedChanged;
            // 
            ...
            RearCamRadio.CheckedChanged += CameraSelection_CheckedChanged;
            // 
            ...
            FrontCamRadio.CheckedChanged += CameraSelection_CheckedChanged;
            // 
            ...
            StringsTablePanel.Margin = new Padding(3, 10, 3, 0);
            ...
            CarNameLabel.Text = "Registration :";
            ...
            ShowGroup.Margin = new Padding(3, 10, 3, 0);
            ...
            ChecksTablePanel.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 33.3333321F));
            ChecksTablePanel.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 33.3333321F));
            ChecksTablePanel.Controls.Add(DriverNameCheck, 0, 0);
            ChecksTablePanel.Controls.Add(CamNameCheck, 1, 0);
            ChecksTablePanel.Controls.Add(SpeedCheck, 2, 0);
            ChecksTablePanel.Controls.Add(CarNameCheck, 0, 1);
            ChecksTablePanel.Controls.Add(DateTimeCheck, 1, 1);
            ChecksTablePanel.Controls.Add(VinCheck, 0, 2);
            ChecksTablePanel.Controls.Add(LocationCheck, 1, 2);
            ChecksTablePanel.Dock = DockStyle.Top;
            ChecksTablePanel.Location = new Point(3, 23);
            ChecksTablePanel.Name = "ChecksTablePanel";
            ChecksTablePanel.RowCount = 3;
            ...
            CarNameCheck.Text = "Registration";
            ...
            CamNameCheck.Text = "Camera Names";
            ...
            LocationCheck.Text = "Lat/Long Coordinates";
            LocationCheck.UseVisualStyleBackColor = true;
            // 
            // VinCheck
            // 
            VinCheck.AutoSize = true;
            VinCheck.Name = "VinCheck";
            VinCheck.Size = new Size(55, 24);
            VinCheck.TabIndex = 15;
            VinCheck.Text = "VIN";
            VinCheck.UseVisualStyleBackColor = true;
            // 
            // InterpolateGroup
            // 
            InterpolateGroup.AutoSize = true;
            InterpolateGroup.Controls.Add(InterpolateTablePanel);
            InterpolateGroup.Dock = DockStyle.Top;
            InterpolateGroup.Margin = new Padding(3, 10, 3, 0);
            ...
            InterpolateGroup.Text = "Interpolation (Frame Generation)";
            // 
            // InterpolateTablePanel
            // 
            InterpolateTablePanel.AutoSize = true;
            InterpolateTablePanel.ColumnCount = 2;
            InterpolateTablePanel.ColumnStyles.Add(new ColumnStyle(SizeType.AutoSize));
            InterpolateTablePanel.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 100F));
            InterpolateTablePanel.Controls.Add(InterpolateFlowPanel, 0, 0);
            InterpolateTablePanel.Controls.Add(InterpolateDescLabel, 1, 0);
            InterpolateTablePanel.Dock = DockStyle.Fill;
            InterpolateTablePanel.Location = new Point(3, 23);
            InterpolateTablePanel.Name = "InterpolateTablePanel";
            InterpolateTablePanel.RowCount = 1;
            InterpolateTablePanel.RowStyles.Add(new RowStyle(SizeType.Percent, 100F));
            InterpolateTablePanel.TabIndex = 0;
            // 
            // InterpolateFlowPanel
            // 
            InterpolateFlowPanel.AutoSize = true;
            InterpolateFlowPanel.AutoSizeMode = AutoSizeMode.GrowAndShrink;
            InterpolateFlowPanel.WrapContents = false;
            ...
            InterpolateFlowPanel.Controls.Add(FpsLabel);
            InterpolateFlowPanel.Controls.Add(FpsCombo);
            ...
            InterpolateCombo.SelectedIndexChanged += InterpolateCombo_SelectedIndexChanged;
            // 
            // FpsLabel
            // 
            ...
            // 
            // InterpolateDescLabel
            // 
            InterpolateDescLabel.AutoSize = false;
            InterpolateDescLabel.Dock = DockStyle.Fill;
            InterpolateDescLabel.Name = "InterpolateDescLabel";
            InterpolateDescLabel.Padding = new Padding(10, 0, 0, 0);
            InterpolateDescLabel.TabIndex = 18;
            InterpolateDescLabel.Visible = false;
            InterpolateDescLabel.Text =
            ...
            InterpolateDescLabel.TextAlign = ContentAlignment.TopLeft;
            // 
            // VideoGroup
            // 
            ...
            VideoGroup.Margin = new Padding(3, 10, 3, 0);
            ...
            tableLayoutPanel1.ColumnStyles.Add(new ColumnStyle(SizeType.AutoSize));
            tableLayoutPanel1.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 100F));
            tableLayoutPanel1.Controls.Add(FlipCheck, 0, 0);
            tableLayoutPanel1.Controls.Add(TrimCheck, 1, 0);
            tableLayoutPanel1.Controls.Add(flowLayoutPanel5, 2, 0);
            tableLayoutPanel1.Controls.Add(SplitCheck, 0, 1);
            tableLayoutPanel1.Controls.Add(ScaleCheck, 1, 1);
            tableLayoutPanel1.Controls.Add(ScaleNum, 2, 1);
            ...
            formToolTip.SetToolTip(FlipCheck, "Flips the rear camera view to as if you were looking out the back of the vehicle.");
            // 
            // ScaleCheck
            // 
            ...
            extraGroup.Margin = new Padding(3, 10, 3, 0);
            ...
            ExtraFlowPlanel.Controls.Add(OverwriteCheck);
            ExtraFlowPlanel.Controls.Add(AppendDateCheck);
            ...
            OverwriteCheck.Size = new Size(180, 24);
            OverwriteCheck.TabIndex = 30;
            OverwriteCheck.Text = "Overwrite existing file(s)";
            OverwriteCheck.UseVisualStyleBackColor = true;
            // 
            //
            // AppendDateCheck
            // 
            AppendDateCheck.AutoSize = true;
            AppendDateCheck.Name = "AppendDateCheck";
            AppendDateCheck.Size = new Size(200, 24);
            AppendDateCheck.TabIndex = 31;
            AppendDateCheck.Text = "Append recording date/time to file name";
            AppendDateCheck.UseVisualStyleBackColor = true;
            // 
            // flowLayoutPanel3
            // 
            ...
            outputFileBox.Text = "Drive Recorder Video.mp4";
            //
            // StartBtn
            // 
            StartBtn.Dock = DockStyle.Top;
            StartBtn.Margin = new Padding(3, 16, 3, 0);
            StartBtn.Location = new Point(3, 844);
            StartBtn.Name = "StartBtn";
            StartBtn.Size = new Size(401, 58);
            ...
            Font = FontHelper.LoadFont("Eixample_Villa_Light.otf", 9.5F);
            MaximizeBox = false;
            ...
            InterpolateTablePanel.ResumeLayout(false);
            InterpolateTablePanel.PerformLayout();
        ...
        private FlowLayoutPanel iDriveFlowPanel;
        private Label iDriveLabel;
        private ComboBox iDriveCombo;
        ...
        private ColoredCheckBox DriverNameCheck;
        private ColoredCheckBox CamNameCheck;
        private ColoredCheckBox CarNameCheck;
        private ColoredCheckBox SpeedCheck;

        private ColoredCheckBox DateTimeCheck;
        private ColoredCheckBox LocationCheck;
        private ColoredCheckBox VinCheck;
        private Button StartBtn;
        private FolderBrowserDialog pathChooseDlg;
        private GroupBox InterpolateGroup;
        private TableLayoutPanel InterpolateTablePanel;
        private FlowLayoutPanel InterpolateFlowPanel;
        private Label InterpolateDescLabel;
        private ColoredCheckBox InterpolateCheck;
        ...
        private ColoredCheckBox MphModeCheck;
        private ColoredCheckBox OverwriteCheck;
        private ColoredCheckBox AppendDateCheck;
        ...
        private ColoredCheckBox FlipCheck;
        private ColoredCheckBox TrimCheck;
        private ColoredCheckBox SplitCheck;
        ...
        private ColoredCheckBox ScaleCheck;
